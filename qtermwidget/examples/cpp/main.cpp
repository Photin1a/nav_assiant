...
#include <iostream>
    ...
    auto str = QStringLiteral("dsadasdsffffffffffffffffssssssssssssssssss\n");
...
int main(int argc, char *argv[]) {
  ...
  actionsMenu->addAction(QStringLiteral("Find..."), console,
                         &QTermWidget::toggleShowSearchBar,
                         QKeySequence(Qt::CTRL + Qt::SHIFT + Qt::Key_F));
  actionsMenu->addAction(QStringLiteral("Copy"), console,
                         &QTermWidget::copyClipboard,
                         QKeySequence(Qt::CTRL + Qt::SHIFT + Qt::Key_C));
  actionsMenu->addAction(QStringLiteral("Paste"), console,
                         &QTermWidget::pasteClipboard,
                         QKeySequence(Qt::CTRL + Qt::SHIFT + Qt::Key_V));
  actionsMenu->addAction(QStringLiteral("About Qt"), &app,
  ...
  qDebug() << QApplication::arguments() << Qt::endl;
  ...
  // real startup
  QObject::connect(console, &QTermWidget::finished, mainWindow,
                   &QMainWindow::close);
